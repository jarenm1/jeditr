...
export const Modal: React.FC<ModalProps> = ({ id, position, pluginName, onClose, onDragEnd, children }) => {
  ...
  return (
    <div
      ...
      style={{ left: position.x, top: position.y, minWidth: 320, minHeight: 80 }}
    >
      <div
      ...
      <div className="p-4 text-[var(--color-fg)]">
        {children}
      </div>
    </div>
  );
