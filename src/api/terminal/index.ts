...
export async function executeCommandUntil(
  ...
  return invoke('execute_terminal_command_until', { sessionId, command, condition: condition.toString(), options })
}
 ...
 * ```
 */
export async function terminateTerminalSession(sessionId: string): Promise<TerminalSession> {
 ...
 * ```
 */
export async function getTerminalWorkingDirectory(sessionId: string): Promise<string> {
 ...
 * ```
 */
export async function setTerminalWorkingDirectory(sessionId: string, directory: string): Promise<void> {
