...
export const Workspace: React.FC<WorkspaceProps> = ({
  ...
  const { removePaneInfo } = useLanguageActions();
  ...
  }, [workspace.id, workspace.panes, workspace.activePaneId, removePaneFromWorkspace, removeWorkspace, removePaneInfo]);
