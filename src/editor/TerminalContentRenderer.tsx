...
import { startTerminalSession, sendTerminalInput } from '@services/terminalSession';
...
const TerminalContentRenderer: React.FC<TerminalContentProps> = ({ content, editorSettings, sessionId: propSessionId, onExit }) => {
